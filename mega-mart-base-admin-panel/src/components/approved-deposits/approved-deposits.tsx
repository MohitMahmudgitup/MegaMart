...
function ApprovedDeposits() {
    ...
    return (
        <div className="p-6 space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-2xl font-semibold text-gray-900">Approved Deposits</h1>
                <p className="text-sm text-gray-600 mt-1">View all successfully approved deposits</p>
            </div>
            ...
            <div className="border rounded-lg">
                <div className="p-4 border-b bg-gray-50">
                    <h2 className="font-medium text-gray-900">
                        Approved Deposits <span className="text-sm font-normal text-gray-500">4</span>
                    </h2>
                </div>
                    ...
                    <TableBody>
                        {filteredDeposits.map((deposit, index) => (
                            <TableRow key={deposit.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                ...
                                <TableCell className="font-medium text-green-600">{deposit.amount}</TableCell>
